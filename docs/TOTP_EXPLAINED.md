...
Trong thực tế, người dùng cần thời gian để mở email/SMS và nhập mã TOTP. Điều này được gọi là "user delay".
...
- **Period = 60s**: Mã chỉ có hiệu lực trong vòng 60 giây (1 window). Nếu user mất 30 giây để nhập mã, vẫn hợp lệ.
